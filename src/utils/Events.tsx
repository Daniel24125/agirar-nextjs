    ...
    const list: TEvent[] = [
        {
            ...
            title: "Convocatória para reunião ordinária",
            date: "20/02/2026",
            img: ["/eventos/20_02_2026/main.jpg"],
            href: "/documentos/Convocatoria 25.pdf",
            abstract: "Convidamos todos os associados a participar na Assembleia Geral",
            desc: "Convocam-se todos os Associados da AGIRAR- Associação de Familiares e Amigos de Pessoas com Psicose para uma Reunião Ordinária às 16:00 do dia 14 de marçoa decorrer na nossa sede."
        },
        {
            id: Math.random().toString(16).slice(2),
            ...
            href: "",
            abstract: "Convidamos todos os associados a participar na Assembleia Geral",
            desc: "Convocam-se todos os Associados da AGIRAR- Associação de Familiares e Amigos de Pessoas com Psicose para uma Reunião Ordinária às 16:00 a decorrer na nossa sede."
        },
        {
            id: Math.random().toString(16).slice(2),
