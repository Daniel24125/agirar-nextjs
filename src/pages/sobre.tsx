    ...
    return <section className='flex flex-col items-center relative w-screen h-[calc(100vh-64px)] '>
       ...
       <div className="w-full flex justify-start">
        <DecorationGeometry
            ...
            className="flex justify-end items-center gap-8 pr-10"
        >
            <div className="flex flex-col justify-end gap-2">
                <p className='font-bold text-2xl'>Todos nós somos AGIRAR</p>
                <p className=' text-right'>Quer fazer parte da nossa família?</p>
            </div>
...
const ObjectivesSection = ()=>{
    ...
    return <section className='flex flex-col items-center w-screen relative top-3 py-11'>
        <div className={`${getMaxWidthClasses} flex justify-between gap-10`}>
            <div className="flex flex-col items-center w-1/2 gap-11 text-center ">
            ...
            <ScrollArea className=" rounded-3xl flex flex-col p-9 bg-blue-100 w-1/2  h-[calc(100vh-200px)]">
                {hist.sort((hp, hn)=>{
                    ...
                    return <div key={h.id} className='flex mb-10 text-black  gap-5'>
                        ...
                        }} className="rounded-full w-12 h-12"></div>
...
const Partners = () => {
    ...
    return <section className='flex flex-col items-center relative w-screen py-36'>
        <div className={`${getMaxWidthClasses} flex flex-col relative items-center`}>
            ...
            <p className='text-3xl max-w-md text-center font-bold'>Com os nossos parceiros, tudo é mais fácil</p>
            <div className="flex justify-start w-full p-10 bg-white items-center rounded-2xl mt-20 gap-4">
                {getPartners.map((p: TPartner)=>{
                    return <a  href={p.href} target="_blank">
                        <img className=' grayscale hover:grayscale-0' src={p.img} alt="partner" key={p.href} />
                    </a>
                })}
